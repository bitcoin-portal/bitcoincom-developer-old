export const content = [
  ...
  },
  {
    ...
    link: '/bitbox/docs/mnemonic',
    code: `// generate 24 word mnemonic
...
// annonce ampleur sanglier peser acheter cultiver abroger embellir résoudre dialogue grappin lanterne`,
  },
  {
    ...
    link: '/bitbox/docs/hdnode',
    code: `// decode raw transaction hex
(async () => {
  try {
...
(async () => {
  ...
  },
  {
    ...
    text: ['Convert between legacy and cash addresses on main or testnet.'],
    link: '/bitbox/docs/address',
    code: `// cashaddr to legacy
...
// true`,
  },
  {
    ...
    text: ['Convert between satoshis and whole units or bits.'],
    link: '/bitbox/docs/bitcoincash',
    code: `// convert 9 $BCH to satoshis
...
// 42423234`,
  },
  {
    ...
    link: '/bitbox/docs/OpCodes',
    code: `// list all op codes
